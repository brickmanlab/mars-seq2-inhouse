...
if (substr(R1_file_path,nchar(R1_file_path)-2,nchar(R1_file_path))==".gz"){
  ...
  new_R1_file_path=paste("_temp/scRNA_",seq_batch_id,"_",substr(fastq_details$R1_file,1,nchar(fastq_details$R1_file)-3),sep="")
...
if (substr(R2_file_path,nchar(R2_file_path)-2,nchar(R2_file_path))==".gz"){
  ...
  new_R2_file_path=paste("_temp/scRNA_",seq_batch_id,"_",substr(fastq_details$R2_file,1,nchar(fastq_details$R2_file)-3),sep="")
...
cmd1=paste("perl",paste(scripts_path,"/extract_labels.pl",sep=""),R1_file_path,R2_file_path,seq_batch_details$R1_design,seq_batch_details$R2_design,seq_batch_id,config$oligos_file,labeled_fastq_path,extract_labels_stats_path,".",seq_batch_details$I5_design)
message(cmd1)
ok=system(cmd1)
if (ok!=0){
